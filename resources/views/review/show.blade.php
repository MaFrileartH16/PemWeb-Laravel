  ...
  <div class="page-wrapper">
    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="card">
          <div class="card-body">
            <form method="GET" action="{{ route('reviews.show', $review->id) }}">

              <!-- User -->
              <div class="mb-3">
                <label for="user_id" class="form-label">Pengguna</label>
                <input type="text" class="form-control" id="user_id" value="{{ $review->user->name }}" readonly>
              </div>

              <!-- Movie -->
              <div class="mb-3">
                <label for="movie_id" class="form-label">Film</label>
                <input type="text" class="form-control" id="movie_id" value="{{ $review->movie->title }}" readonly>
              </div>

              <!-- Rating -->
              <div class="mb-3">
                <label for="rating" class="form-label">Rating</label>
                <input type="text" class="form-control" id="rating" value="{{ $review->rating }} -
              @if ($review->rating == 1)
                Sangat Buruk
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" id="review" rows="4" readonly>{{ $review->review }}</textarea>
              </div>
