    ...
    <div class="page-header d-print-none">
      <div class="container-xl">
        <div class="row g-2 align-items-center">
          <div class="col">
            <h2 class="page-title">Tambah Film</h2>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('movies.store') }}" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="year" name="year" placeholder="Masukkan Tahun Rilis"
                       required>
              </div>
              ...
              <!-- Poster Preview -->
              <img id="poster-preview" src="#" alt="Poster Preview" style="max-width: 200px; display: none;"/>
